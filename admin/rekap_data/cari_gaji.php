    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		<?php
			...
			echo'
				<form method="POST" action="cari_gaji.php" target="_blank" class="form-inline">
					<input type="search" name="bln" placeholder="Pencarian" class="form-control" class="col-sm-4" />
					<input type="submit" class="btn btn-info btn-sm" name="cari" value="GO"></form>
					<button class="btn btn-default btn-sm"><a href="print_gaji.php?bln='.$bln.'"  target="_blank">
            ...
            <div class="box-body">
			  <table id="example2" class="table table-bordered table-hover">
				...
				<?php 
						...
						$sql 		= mysqli_query($koneksi, "SELECT * from t_gaji WHERE bln like '%$bln%' ");
					...
					<td><center>
						<a href='hapus.php?nip=$data[nip]' class='btn btn-danger btn-xs' onClick='return hapus()'title='Hapus Data'>
							<span class='glyphicon glyphicon-remove'></span> Hapus</a>
						<a href='slip_gaji.php?bln=$data[bln]' target='_blank' class='btn btn-info btn-xs' title='Print Slip'>
