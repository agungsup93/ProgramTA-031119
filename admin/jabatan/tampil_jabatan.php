...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
		<li>
			<button class="btn btn-default btn-xs"><a href="tambah_jabatan.php">
			<span class="glyphicon glyphicon-plus"></span> Tambah Data</a></button>
		</li>
		<li>
			<button class="btn btn-default btn-xs"><a href="print_jabatan.php" target="_blank">
            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped bg-info">
                ...
                <tbody>
					...
					<td><center>
						<a href='hapus_jabatan.php?gol=$data[gol]' class='btn btn-danger btn-xs' onClick='return hapus()'title='Hapus Data'>
							<span class='glyphicon glyphicon-remove'></span> Hapus</a>
						<a href='edit_jabatan.php?gol=$data[gol]' class='btn btn-warning btn-xs' title='Ubah Data'>
